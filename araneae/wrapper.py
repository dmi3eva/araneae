...
class Araneae:
    def __init__(self):
        ...
        self.EXTRACTION_FUNCTIONS = {
            QueryType.BINARY: lambda sample: araneae._specifications_from_mentions(QueryType.BINARY, sample),
            QueryType.DATETIME: lambda sample: araneae._specifications_from_mentions(QueryType.DATETIME, sample),
            QueryType.SIMPLICITY: lambda sample: araneae._specifications_simplicity(sample),
            QueryType.JOIN: lambda sample: araneae._specifications_join(sample),
