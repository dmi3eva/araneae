...
1️⃣ Может ли этот текст быть вопросом к базе данных?

<i> {nl} </i>

<b>Пояснение:</b>
\U000025CF Естественно ли это звучит?
\U000025CF Содержится ли в тексте запрос на получение информации?
'''


FLUENCY_SUBSTITUTION_DESCRIPTION = '''

2️⃣ А этот текст быть вопросом к базе данных?
...
Значит ли наш вопрос то же самое?
...
Соответствует ли ему этот вопрос:
